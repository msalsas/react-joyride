...
var JoyrideTooltip = function (_React$Component) {
  ...
  _createClass(JoyrideTooltip, [{
    ...
    value: function setStyles(stepStyles, opts, props) {
      ...
      styles.hole = {
        top: Math.round(opts.rect.top - (0, _utils.getBoundingClientRectFromElement)(document.body).top - 5),
    ...
    value: function setOpts() {
      ...
      var opts = {
        ...
        rect: (0, _utils.getBoundingClientRectFromElement)(target, offsetParent),
      ...
      if ((/^bottom$/.test(opts.positionClass) || /^top$/.test(opts.positionClass)) && xPos > -1) {
        ...
        /* istanbul ignore else */
        if (tooltip) {
          opts.tooltip = (0, _utils.getBoundingClientRectFromElement)(tooltip, offsetParent);
        }
