...
import { getRootEl, getBoundingClientRectFromElement, logger, sanitizeSelector, getDocHeight } from './utils';
...
var Joyride = function (_React$Component) {
  ...
  _createClass(Joyride, [{
    ...
    value: function getScrollTop() {
      ...
      var rect = getBoundingClientRectFromElement(target, offsetParent);
    ...
    value: function calcPlacement() {
      ...
      if (step && (standaloneData || isRunning && steps[index])) {
        ...
        var position = this.calcPosition(step);
        var scrollingElement = getBoundingClientRectFromElement(document.body);
    ...
    value: function calcPosition(step) {
      ...
      var body = getBoundingClientRectFromElement(document.body);
      var target = document.querySelector(step.selector);
      var component = this.getElementDimensions(showTooltip ? '.joyride-tooltip' : '.joyride-beacon');
      var rect = getBoundingClientRectFromElement(target);
    ...
    value: function createComponent() {
      ...
      var _props6 = this.props,
          disableOverlay = _props6.disableOverlay,
          holePadding = _props6.holePadding,
          locale = _props6.locale,
          offsetParentSelector = _props6.offsetParentSelector,
          showBackButton = _props6.showBackButton,
          showOverlay = _props6.showOverlay,
          showSkipButton = _props6.showSkipButton,
          showStepsProgress = _props6.showStepsProgress,
          steps = _props6.steps,
          type = _props6.type;
